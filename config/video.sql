...
INSERT INTO video_info(title,play_num,like_num,publish_time,author,comment_num)
    VALUES("Video1",100,200,'2020-01-11 09:53:32','Author1',300);

INSERT INTO video_info(title,play_num,like_num,publish_time,author,comment_num)
    VALUES("Video2",1000,2000,'2020-01-12 09:53:32','Author1',3000);

INSERT INTO video_info(title,play_num,like_num,publish_time,author,comment_num)
    VALUES("Video3",10000,20000,'2020-01-13 09:53:32','Author2',30000);

INSERT INTO video_url(ID,play_url,cover_url)
    VALUES(1,
